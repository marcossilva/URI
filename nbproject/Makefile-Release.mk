...
${OBJECTDIR}/1168_LED.o: 1168_LED.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1168_LED.o 1168_LED.cpp

${OBJECTDIR}/1234_Stenca_Dancante.o: 1234_Stenca_Dancante.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1234_Stenca_Dancante.o 1234_Stenca_Dancante.cpp

${OBJECTDIR}/1237_Comparacao_Substring.o: 1237_Comparacao_Substring.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1237_Comparacao_Substring.o 1237_Comparacao_Substring.cpp

${OBJECTDIR}/1332_Um_Dois_Tres.o: 1332_Um_Dois_Tres.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1332_Um_Dois_Tres.o 1332_Um_Dois_Tres.cpp
...
${OBJECTDIR}/1168_LED_nomain.o: ${OBJECTDIR}/1168_LED.o 1168_LED.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1168_LED_nomain.o 1168_LED.cpp;\
	else  \
...
${OBJECTDIR}/1234_Stenca_Dancante_nomain.o: ${OBJECTDIR}/1234_Stenca_Dancante.o 1234_Stenca_Dancante.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1234_Stenca_Dancante_nomain.o 1234_Stenca_Dancante.cpp;\
	else  \
...
${OBJECTDIR}/1237_Comparacao_Substring_nomain.o: ${OBJECTDIR}/1237_Comparacao_Substring.o 1237_Comparacao_Substring.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1237_Comparacao_Substring_nomain.o 1237_Comparacao_Substring.cpp;\
	else  \
...
${OBJECTDIR}/1332_Um_Dois_Tres_nomain.o: ${OBJECTDIR}/1332_Um_Dois_Tres.o 1332_Um_Dois_Tres.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1332_Um_Dois_Tres_nomain.o 1332_Um_Dois_Tres.cpp;\
	else  \
